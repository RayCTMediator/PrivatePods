...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/RayCTMediator/BProject"
  ...
  s.source       = { :git => "https://github.com/RayCTMediator/BProject.git", :tag => s.version.to_s }
  ...
  s.source_files  = "BProject/BProject/**/*.{h,m,swift}"
